...
def get_paths(source_gml_file, target_json_file):
    ...
    G = fiber_graph.import_gml_graph(source_gml_file)
    pid = 0
...
if __name__ == "__main__":
    if 0:  # Base Paths
        convert_paths_onset_to_json("/home/USERNAME/onset/data/results/sprint_add_circuit_heuristic_10/__0/paths/ecmp_0", 
                                    "/home/USERNAME/ripple/simulator/topologies/sprint/path.json")

    if 1: # Reroute Paths
        convert_paths_onset_to_json("/home/USERNAME/onset/data/results.old/surfNet_add_circuit_heuristic_10/9_20/paths/ecmp_0",
                                    "/home/USERNAME/ripple/simulator/topologies/surfNet/9_20_paths.json")

    if 0: 
        with open("/home/USERNAME/onset/notes.json", 'r') as fob:
            config = json.load(fob)

        for network in config:
            makedirs(path.join("/home/USERNAME/ripple/simulator/topologies", network), exist_ok=True)
