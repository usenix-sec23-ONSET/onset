...
def main():
    ...
    if experiment == "ANS_smc10":
        TOPO                    = '/home/USERNAME/ripple/simulator/topologies/ANS/ANS_1-20.gml'
        UPDATED_TOPO            = '/home/USERNAME/onset/data/graphs/ANS_Updated_source_link_only.gml'
        PATH_DB                 = '/home/USERNAME/onset/data/paths/ANS.json'
        ATTACK                  = '/home/USERNAME/onset/data/traffic/ANS_targets_10_strength_10.json'
        CONGESTION              = '/home/USERNAME/ripple/simulator/logs/ANS_1Tbps_ripple/link_util.csv'
        REROUTED_PATHS          = '/home/USERNAME/onset/data/paths/ANS_Rerouted_source_link_only.json'
        NEW_LINK_MAX_HOPS       = 3
        N_TARGET_LINKS          = 10
        MAX_LINK_UTIL           = 0.95
    ...
    if experiment == "sprint_smc10":
        TOPO                    = '/home/USERNAME/ripple/simulator/topologies/sprint/sprint_1-20.gml'
        UPDATED_TOPO            = '/home/USERNAME/onset/data/graphs/sprint_Updated_source_link_only.gml'
        PATH_DB                 = '/home/USERNAME/onset/data/paths/sprint.json'
        ATTACK                  = '/home/USERNAME/onset/data/traffic/sprint_targets_10_strength_10.json'
        CONGESTION              = '/home/USERNAME/ripple/simulator/logs/sprint_1Tbps_ripple/link_util.csv'
        REROUTED_PATHS          = '/home/USERNAME/onset/data/paths/sprint_Rerouted_source_link_only.json'
        NEW_LINK_MAX_HOPS       = 3
        N_TARGET_LINKS          = 10
        MAX_LINK_UTIL           = 0.95
        SOURCE_LINK_ADDITION    = False # new links start from the target link's source node
    ...
    if experiment == "grid_3_smc10":
        TOPO                    = '/home/USERNAME/onset/data/graphs/gml/grid_3.gml'
        UPDATED_TOPO            = '/home/USERNAME/onset/data/graphs/grid_3_Updated_source_link_only.gml'
        PATH_DB                 = '/home/USERNAME/onset/data/paths/grid_3.json'
        ATTACK                  = '/home/USERNAME/onset/data/traffic/grid_3_targets_10_strength_10.json'
        CONGESTION              = '/home/USERNAME/ripple/simulator/logs/grid_3_ripple/link_util.csv'
        REROUTED_PATHS          = '/home/USERNAME/onset/data/paths/grid_3_Rerouted_source_link_only.json'
        NEW_LINK_MAX_HOPS       = 3
        N_TARGET_LINKS          = 10
        MAX_LINK_UTIL           = 0.95
        SOURCE_LINK_ADDITION    = False # new links start from the target link's source node
    ...
    if experiment == "linear_10_smc10":
        TOPO                    = '/home/USERNAME/onset/data/graphs/gml/linear_10.gml'
        UPDATED_TOPO            = '/home/USERNAME/onset/data/graphs/linear_10_Updated_source_link_only.gml'
        PATH_DB                 = '/home/USERNAME/onset/data/paths/linear_10.json'
        ATTACK                  = '/home/USERNAME/onset/data/traffic/linear_10_targets_10_strength_10.json'
        CONGESTION              = '/home/USERNAME/ripple/simulator/logs/linear_10_ripple/link_util.csv'
        REROUTED_PATHS          = '/home/USERNAME/onset/data/paths/linear_10_Rerouted_source_link_only.json'
        NEW_LINK_MAX_HOPS       = 3
        N_TARGET_LINKS          = 10
        MAX_LINK_UTIL           = 0.95
        SOURCE_LINK_ADDITION    = False # new links start from the target link's source node
    ...
    if experiment == "whisker_3_2_smc10":
        TOPO                    = '/home/USERNAME/onset/data/graphs/gml/whisker_3_2.gml'
        UPDATED_TOPO            = '/home/USERNAME/onset/data/graphs/whisker_3_2_Updated_source_link_only.gml'
        PATH_DB                 = '/home/USERNAME/onset/data/paths/whisker_3_2.json'
        ATTACK                  = '/home/USERNAME/onset/data/traffic/whisker_3_2_targets_8_strength_10.json'
        CONGESTION              = '/home/USERNAME/ripple/simulator/logs/whisker_3_2_ripple/link_util.csv'
        REROUTED_PATHS          = '/home/USERNAME/onset/data/paths/whisker_3_2_Rerouted_source_link_only.json'
        NEW_LINK_MAX_HOPS       = 3
        N_TARGET_LINKS          = 10
        MAX_LINK_UTIL           = 0.95
        SOURCE_LINK_ADDITION    = False # new links start from the target link's source node
        ...
        TOPO                    = '/home/USERNAME/ripple/simulator/topologies/ANS/ANS_1-20.gml'
        UPDATED_TOPO            = '/home/USERNAME/onset/data/graphs/ANS_Updated_any_link.gml'
        PATH_DB                 = '/home/USERNAME/onset/data/paths/ANS.json'
        ATTACK                  = '/home/USERNAME/onset/data/traffic/ANS_targets_10_strength_10.json'
        CONGESTION              = '/home/USERNAME/ripple/simulator/logs/ANS_1Tbps_ripple/link_util.csv'
        REROUTED_PATHS          = '/home/USERNAME/onset/data/paths/ANS_Rerouted_any_link.json'
        NEW_LINK_MAX_HOPS       = 3
        N_TARGET_LINKS          = 10
        MAX_LINK_UTIL           = 0.95
        SOURCE_LINK_ADDITION    = False # new links start from the target link's source node
        ...
        # TODO
        TOPO                    = '/home/USERNAME/onset/data/graphs/ANS_Updated_any_link.gml'
        UPDATED_TOPO            = ''
        PATH_DB                 = '/home/USERNAME/onset/data/paths/ANS_Rerouted_any_link.json'
        ATTACK                  = '/home/USERNAME/onset/data/traffic/ANS_targets_10_strength_10.json'
        CONGESTION              = '/home/USERNAME/ripple/simulator/logs/ANS_1Tbps_ripple/link_util.csv'
        REROUTED_PATHS          = ''
        NEW_LINK_MAX_HOPS       = 3
    ...
    if REPEAT:
            ...
            CONGESTION = '/home/USERNAME/ripple/simulator/logs/ANS_1Tbps_ripple_reroute_onset/link_util.csv'
