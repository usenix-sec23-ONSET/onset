...
def main(network, iterations, agg_vol, benign_vol, atk_vol):
    joint_path = "/home/USERNAME/onset/data/results/{}_compare_{}_{}_{}_{}-{}".format(network,iterations, agg_vol, agg_vol, benign_vol, atk_vol)
    joint_id = joint_path.split('/')[-1]
    print("\nExperiment Joint ID: {}".format(joint_id))

    experiment_paths = [
        "/home/USERNAME/onset/data/results/{}_attack_heuristic_0_{}_{}-{}".format(network, agg_vol, benign_vol, atk_vol),
        "/home/USERNAME/onset/data/results-2022-01-06/{}_attack_heuristic_7_10_{}_{}-{}".format(network, agg_vol, benign_vol, atk_vol),
        "/home/USERNAME/onset/data/results/{}_attack_heuristic_7_10_{}_{}-{}".format(network, agg_vol, benign_vol, atk_vol)
    ]
