...
from src.utilities import SCRIPT_HOME, ZERO_INDEXED
from src.utilities.plotters import congestion_multi_cdf, plot_points, plot_timeseries, plot_reconfig_time, congestion_multi_cdf_v2
...
if __name__ == "__main__":
    ...
    if 0:
        ...
        for network in networks:
            # post_proc_timeseries("/home/USERNAME/onset/data/results/{}_attack".format(network),
            #                      "/home/USERNAME/onset/data/results/{}_attack-no-topology-adaptation".format(network), network, 20)
            post_proc_timeseries(["/home/USERNAME/onset/data/results/{}_attack-no-topology-adaptation".format(network),
                                  "/home/USERNAME/onset/data/results/{}_attack".format(network),
                                  "/home/USERNAME/onset/data/results/{}_attack_15".format(network)
                                 ], 
                                 network, 20, 
                                 series_labels=["No Defense", "Alp-Wolf: 10", "Alp-Wolf: 15"])
            # time_series_files = ["/home/USERNAME/onset/data/results/{}_attack_heuristic_0_{}".format(net, proportion), 
            #                 "/home/USERNAME/onset/data/results/{}_attack_heuristic_7_10_{}".format(net, proportion)]


    if 1: 
        time_series_files = [
                            "/home/USERNAME/onset/data/results-2022-02-11/sprint_optimal_3_link_attack_10_0Gbps-150Gbps",
                            
                            "/home/USERNAME/onset/data/results/sprint_optimal_3_link_attack_10_0Gbps-150Gbps_-mcf"
                            #  "/home/USERNAME/onset/data/results/sprint_attack_heuristic_7_10_0Gbps-150Gbps"
                            ]
        net = "sprint"
        iterations = 3
