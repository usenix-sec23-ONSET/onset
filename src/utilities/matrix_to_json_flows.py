...
if __name__ == "__main__":
    ...
    for network in config: 
        for txt_p, json_p in [('BaseTMTxt', 'BaseTMJSON'), 
            ...
            adaptive_flows = "/home/USERNAME/ripple/simulator/topologies/" + network + "/" + tag + "AdaptivePaths.json"
            ...
            with open("/home/USERNAME/onset/notes_v2.json", 'w') as fob:
                json.dump(config, fob, indent=4)

    if 0: 
        base_traffic_matrix = "/home/USERNAME/onset/data/traffic/sprint.txt"
        attack_traffic_matrix = "/home/USERNAME/onset/data/traffic/sprint_link_2_9_strength_11"
        json_paths = "/home/USERNAME/ripple/simulator/topologies/sprint/path.json"
        out_file = "/home/USERNAME/ripple/simulator/topologies/sprint/attack_100G.json"
        congestion_factor = 1.0
